...
RUN apt-get update
RUN DEBIAN_FRONTEND=noninteractive apt-get -y install php5 php5-cli php5-mcrypt php5-gd php5-json php5-mysql php5-memcached apache2 libapache2-mod-php5 curl php5-curl git-core php5-xdebug
